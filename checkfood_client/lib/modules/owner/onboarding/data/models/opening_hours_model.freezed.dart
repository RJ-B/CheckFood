...
abstract class $OpeningHoursModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String dayOfWeek, String? openAt, String? closeAt, bool closed});
}
...
class _$OpeningHoursModelImpl implements _OpeningHoursModel {
  ...
  @override
  String toString() {
    return 'OpeningHoursModel(dayOfWeek: $dayOfWeek, openAt: $openAt, closeAt: $closeAt, closed: $closed)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, dayOfWeek, openAt, closeAt, closed);
